...
VE Foundry Client is an independent/private fork of JeidoUran's [FVTT Player Client](https://github.com/JeidoUran/fvtt-player-client). It was detached from the original fork network so this rebranded client could keep receiving changes specific to our game group's needs, mainly because the previous fork had not been updated in over 12 months and we wanted a few extra features and workflow changes.

If those changes suit your table, you are welcome to use this fork. Credit for the original work goes to [theripper93](https://github.com/theripper93), [omegarogue](https://github.com/OmegaRogue), and [JeidoUran](https://github.com/JeidoUran).

This app is currently unsigned. Windows Defender, SmartScreen, or your antivirus software may warn you when downloading or installing it. If you do not want to trust it, do not use it.
...
| Import original app settings on first run        |          ![No](https://img.shields.io/badge/-✗-cf222e)           |         ![No](https://img.shields.io/badge/-✗-cf222e)          |        ![No](https://img.shields.io/badge/-✗-cf222e)         |        ![Yes](https://img.shields.io/badge/-✓-2ea44f)         |
| Toggle to open external links in default browser |          ![No](https://img.shields.io/badge/-✗-cf222e)           |         ![No](https://img.shields.io/badge/-✗-cf222e)          |        ![No](https://img.shields.io/badge/-✗-cf222e)         |        ![Yes](https://img.shields.io/badge/-✓-2ea44f)         |
| Per-server auto status refresh exclusion         |          ![No](https://img.shields.io/badge/-✗-cf222e)           |         ![No](https://img.shields.io/badge/-✗-cf222e)          |        ![No](https://img.shields.io/badge/-✗-cf222e)         |        ![Yes](https://img.shields.io/badge/-✓-2ea44f)         |
| Release notes in update checker                  |          ![No](https://img.shields.io/badge/-✗-cf222e)           |         ![No](https://img.shields.io/badge/-✗-cf222e)          |        ![No](https://img.shields.io/badge/-✗-cf222e)         |        ![Yes](https://img.shields.io/badge/-✓-2ea44f)         |
| Update available button indicator                |          ![No](https://img.shields.io/badge/-✗-cf222e)           |         ![No](https://img.shields.io/badge/-✗-cf222e)          |        ![No](https://img.shields.io/badge/-✗-cf222e)         |        ![Yes](https://img.shields.io/badge/-✓-2ea44f)         |
| Favorite website quick links                     |          ![No](https://img.shields.io/badge/-✗-cf222e)           |         ![No](https://img.shields.io/badge/-✗-cf222e)          |        ![No](https://img.shields.io/badge/-✗-cf222e)         |        ![Yes](https://img.shields.io/badge/-✓-2ea44f)         |
| Play/edit mode for cleaner main screen           |          ![No](https://img.shields.io/badge/-✗-cf222e)           |         ![No](https://img.shields.io/badge/-✗-cf222e)          |        ![No](https://img.shields.io/badge/-✗-cf222e)         |        ![Yes](https://img.shields.io/badge/-✓-2ea44f)         |
| Server and favorite column layout controls       |          ![No](https://img.shields.io/badge/-✗-cf222e)           |         ![No](https://img.shields.io/badge/-✗-cf222e)          |        ![No](https://img.shields.io/badge/-✗-cf222e)         |        ![Yes](https://img.shields.io/badge/-✓-2ea44f)         |
| Independent server and favorite list scrolling   |          ![No](https://img.shields.io/badge/-✗-cf222e)           |         ![No](https://img.shields.io/badge/-✗-cf222e)          |        ![No](https://img.shields.io/badge/-✗-cf222e)         |        ![Yes](https://img.shields.io/badge/-✓-2ea44f)         |
| Region-aware Favorite/Favourite labels           |          ![No](https://img.shields.io/badge/-✗-cf222e)           |         ![No](https://img.shields.io/badge/-✗-cf222e)          |        ![No](https://img.shields.io/badge/-✗-cf222e)         |        ![Yes](https://img.shields.io/badge/-✓-2ea44f)         |
...
On first run, VE Foundry Client checks for saved settings from the original FVTT Desktop Client app, including older `vtt-desktop-client` data folders. If settings are found, the app prompts to import servers, themes, and login details into VE Foundry Client's own app data folder.
