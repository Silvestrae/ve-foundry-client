...
export const GameConfigSchema = z.object({
  ...
  cachedFoundryVersion: z.string().optional(),
  cachedGameSystem: z.string().optional(),
  cachedGameSystemVersion: z.string().optional(),
...
const UserDataStaticSchema = z.object({
  ...
  originalImportCompletedAt: z.string().optional(),
  originalImportCompletedAppName: z.string().optional(),
